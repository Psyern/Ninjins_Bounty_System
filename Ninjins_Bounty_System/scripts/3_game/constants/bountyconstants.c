...
const int obfv_BOUNTY_NOTIFICATION_EXPIRED_BROADCAST = 26;
const int obfv_BOUNTY_NOTIFICATION_WIN_BROADCAST = 27;
const int obfv_BOUNTY_NOTIFICATION_SUICIDE_BROADCAST = 28;
const int obfv_BOUNTY_NOTIFICATION_LOGOUT_BROADCAST = 29;
const int obfv_BOUNTY_NOTIFICATION_WARNING_BROADCAST = 30;
const int obfv_BOUNTY_NOTIFICATION_BOUNTY_PAUSED_IN_SAFEZONE = 31;
...
const float obfv_BOUNTY_STATIC_ZONE_DEFAULT_RADIUS = 150.0;
